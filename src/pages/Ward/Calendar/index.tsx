...
import { getWardShiftCollection } from '@/api/ward';
...
const WardCalendarPage = () => {
  ...
  const { data: collection, isLoading } = useQuery({
    queryKey: wardKeys.shiftList(account.wardId, account.shiftTeamId, year, month),
    queryFn: () => getWardShiftCollection(account.wardId, account.shiftTeamId, year, month),
  });
