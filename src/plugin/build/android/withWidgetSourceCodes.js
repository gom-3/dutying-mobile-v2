...
async function prepareSourceCodes(
  ...
  const widgetSourceFilePath = path_1.default.join(source, `Widget.kt`);
  if (!fs_1.default.existsSync(source)) {
    ...
    let newContent = content.replace(/SampleWidget/, `Widget`);
  ...
  const widgetDestFilePath = path_1.default.join(dest, `Widget.kt`);
